...
from examples import audio_recorder


@pytest.mark.skip_unless_audio
@pytest.mark.accelerated_networking
def test_audio_recorder(
    tmp_path, frame_limit, hololink_address, ibv_name, ibv_port, capsys
):
    # Capture-only (--no-playback): exercises the I2S RX -> RoCE -> decode -> WAV
