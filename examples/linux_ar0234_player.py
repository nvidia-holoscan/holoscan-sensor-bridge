...
def main():
    ...
    parser.add_argument(
        "--camera-mode",
        type=int,
        default=hololink_module.sensors.ar0234.ar0234_mode.Ar0234_Mode.AR0234_MODE_1920X1200_30FPS.value,
        help="AR0234 mode",
    )
