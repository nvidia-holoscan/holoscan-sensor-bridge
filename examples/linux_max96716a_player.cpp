...
/// Holoviz recognises it as a color image. Equivalent to the Python
/// InstrumentedTimeProfiler's `cp_frame[:pixels].reshape(height, width, 3)`.
...
public:
        ...
        holoscan::ExecutionContext& context) override
    {
        ...
        if (in_tensor->size() < pixels) {
            // Short frame — drop it. Holoviz can't render a partial image.
            return;
        }
...
int main(int argc, char** argv)
{
    ...
    hololink::module::EnumerationMetadata sif_metadata = metadata;
