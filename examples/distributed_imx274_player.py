...
class VisualizerFragment(holoscan.core.Fragment):
    def __init__(
        ...
        logging.info("VisualizerFragment::__init__")
        super().__init__(app, name)
        self._headless = headless
        self._fullscreen = fullscreen

    def compose(self):
        logging.info("VisualizerFragment::compose")
...
class HoloscanApplication(holoscan.core.Application):
    def __init__(
        ...
        logging.info("HoloscanApplication::__init__")
        super().__init__()
        self._headless = headless
        self._fullscreen = fullscreen
        self._cuda_context = cuda_context
    ...
    def compose(self):
        ...
        visualizer_fragment = VisualizerFragment(
            self,
            name="visualizer_fragment",
            headless=self._headless,
            fullscreen=self._fullscreen,
        )
