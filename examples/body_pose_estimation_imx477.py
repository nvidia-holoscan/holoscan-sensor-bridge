...
class PostprocessorOp(Operator):
    ...
    * Make boxes compatible with Holoviz
    ...
    def compute(self, op_input, op_output, context):
        ...
        data = {
            "boxes": cp.stack([x1, y1, x2, y2], axis=-1).transpose([1, 0]),
...
class HoloscanApplication(holoscan.core.Application):
    ...
    def compose(self):
        ...
        image_processor_operator = hololink_module.operators.ImageProcessorOp(
            ...
            # Optical black value for imx477 is 50
            optical_black=50,
        ...
        if "image_dim" not in postprocessor_args:
            postprocessor_args["image_dim"] = (
                preprocessor_args["resize_width"],
                preprocessor_args["resize_height"],
            )
