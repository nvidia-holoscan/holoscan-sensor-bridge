...
def main():
    ...
    parser.add_argument(
        "--camera-mode",
        type=int,
        default=hololink_module.sensors.imx715.imx715_mode.Imx715_Mode.IMX715_MODE_3840X2176_30FPS.value,
        help="IMX715 mode",
    )
    ...
    camera = hololink_module.sensors.imx715.imx715.Imx715Cam(
        hololink_channel, expander_configuration=args.expander_configuration
    )
    camera_mode = hololink_module.sensors.imx715.imx715_mode.Imx715_Mode(
        args.camera_mode
    )
