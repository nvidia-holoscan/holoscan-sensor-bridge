...
#ifndef MACRONIX_MX25U25645G_HPP
#define MACRONIX_MX25U25645G_HPP
...
public:
    ...
    // Device identifiers
    static constexpr uint8_t MACRONIX = 0xC2;
    static constexpr uint16_t MX25U25645G = 0x2539;
    ...
    MacronixMx25u25645g(const std::string& context, std::shared_ptr<Hololink> hololink, uint32_t spi_address);
    virtual ~MacronixMx25u25645g() = default;
...
#endif // MACRONIX_MX25U25645G_HPP