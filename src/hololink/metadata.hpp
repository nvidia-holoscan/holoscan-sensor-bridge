...
/**
 * A container that contains key-value pairs with unique keys, values can be eiter `int64_t`,
...
public:
    ...
    /**
     * @brief Get a value of a given type with the given key. If the key is not present it wont be
     * insterted and an empty value is returned.
     *
     * @tparam T value type
     * @param name key name
