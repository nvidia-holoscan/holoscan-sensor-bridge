...
int main(int argc, char** argv)
{
    ...
    COEDataPlane coe_data_plane_0(
        hsb,
        address,
        data_plane_id,
        sensor_id_0);
    COEDataPlane coe_data_plane_1(
        hsb,
        address,
        data_plane_id,
        sensor_id_1);
    ...
    loop_stereo_vb1940(loop_config, vb1940_0, coe_data_plane_0, tensor_0, vb1940_1, coe_data_plane_1, tensor_1);
