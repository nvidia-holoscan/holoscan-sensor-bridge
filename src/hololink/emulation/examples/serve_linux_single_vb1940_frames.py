...
def main():
    parser = argparse.ArgumentParser(
        description="Serve CSI-2 data as if from a single vb1940 sensor using Linux data plane"
    )
    parser.add_argument(
        "ip_address",
        type=str,
    ...
    # NOTE: this is the UUID of the Leopard Eagle board,
    ...
    try:
        loop_single_vb1940(loop_config, vb1940, linux_data_plane, args.gpu)
