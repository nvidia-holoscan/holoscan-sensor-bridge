...
void print_usage(char const* program_name)
{
    printf("Usage: %s [options] <hololink_ip_address>\n"
           "    serves csi-2 data as if from a stereo vb1940 sensor from ip address 'hololink_ip_address'\n\n"
...
int main(int argc, char** argv)
{
    ...
    sensors::Vb1940Emulator vb1940_0;
    sensors::Vb1940Emulator vb1940_1;
    // On Leopard Eagle, the i2c bus address is the sensor_id offset from CAM_I2C_BUS
    vb1940_0.attach_to_i2c(hsb.get_i2c(hololink::I2C_CTRL), hololink::CAM_I2C_BUS + sensor_id_0);
    vb1940_1.attach_to_i2c(hsb.get_i2c(hololink::I2C_CTRL), hololink::CAM_I2C_BUS + sensor_id_1);
    ...
    loop_stereo_vb1940(loop_config, vb1940_0, linux_data_plane_0, tensor_0, vb1940_1, linux_data_plane_1, tensor_1);
