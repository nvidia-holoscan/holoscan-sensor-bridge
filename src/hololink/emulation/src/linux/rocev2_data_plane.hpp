 ...
 */
struct RoCEv2Ctxt {
    // First member is the linux DataPlaneCtxt extension, which itself first-members the
    // common DataPlaneCtxt. &rocev2_ctxt == &rocev2_ctxt->base ==
    // &rocev2_ctxt->base.base == DataPlaneCtxt*. Register slices reachable via
