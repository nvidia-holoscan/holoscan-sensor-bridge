...
| HOST_WIDTH                                    | 8, 16, 32, 64, 128, 256, 512                                                                                                                                                                                                                                         | Width of the Host AXI Stream TDATA in bits. This number must be byte-aligned. Meaning, it must be a number divisible by 8.                |
