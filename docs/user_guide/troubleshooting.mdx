...
[release notes page](release_notes.mdx).
...
## Segmentation fault crashes the GPU

On IGX Orin if your GPU is left in a bad state after a segmentation fault and you see
"ERR!" when running nvidia-smi, e.g.,
...
|                                         |                        |               MIG M. |
|=========================================+========================+======================|
|   0  NVIDIA RTX A6000               Off |   00000005:09:00.0 N/A |                  N/A |
|ERR!  ERR! ERR!             N/A  /  N/A  |       1MiB /  49140MiB |     N/A      Default |
|                                         |                        |                 ERR! |
+-----------------------------------------+------------------------+----------------------+
```

Check the driver version returned from the command and upgrade to `535.309.01` following
the instructions from the [setup section](setup.mdx). The instructions on the setup page
will also upgrade from IGX OS 1.1.2 to 1.1.3.
...
[reprogramming your device](sensor_bridge_firmware_setup.mdx).
