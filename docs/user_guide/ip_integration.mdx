...
| UUID[127:0]                                   | 128'h889B7CE3_65A5_4247_8B05_4FF1904C3359 for Lattice LF-SNSR-ETH-EVN<br />128'hED6A9292_DEBF_40AC_B603_A24E025309C1 for Microchip MPF200-ETH-SENSOR-BRIDGE<br />128'hF1627640_B4DC_48AF_A360_C65B09B3D230 for Leopard Imaging VB1940 Eagle Camera<br />128'h9957A9AC_36B5_4518_83EC_5D514AECB750 for TauroTech DA326 | Universally Unique Identifier are used to identify the board to fetch and remote flash the correct bitfile.                               |
...
| N_INIT_REG                                    | undefined, Integer value                                                                                                                                                                                                                                                                                              | Number of initialization registers.                                                                                                       |
...
[Sensor Interface to Virtual Port Mapping](dataplane.mdx#sensor-interface-to-virtual-port-mapping)
