...
| frequent I2C failures with emulator sending to Thor host device | failed packet receipt on Thor mGbE interface with no retries in JP 7.0 with SIPL rel 38.2.1 | upgrade to JP 7.1 EA |
